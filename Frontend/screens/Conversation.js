...
// const SOCKET_SERVER_URL = 'http://192.168.191.117:3600'; 
...
import {
    ...
    KeyboardAvoidingView, Platform, SafeAreaView, Image, Pressable, Linking
} from 'react-native';
    ...
    const renderMessage = ({ item }) => {
        ...
        return (
            <View style={[
                ...
                <Text style={styles.messageText}>{item.text}</Text>
                {item.status && (
                    <Text style={styles.statusText}>{isMyMessage ? item.status : ''}</Text>
                )}
            </View>
        );
    };
...
const styles = StyleSheet.create({
    ...
    myMessageContainer: {
        backgroundColor: '#59008F', alignSelf: 'flex-end',
    },
    otherMessageContainer: {
        backgroundColor: '#555', alignSelf: 'flex-start',
    },
    ...
    input: {
        flex: 1, padding: 10, borderRadius: 25, backgroundColor: '#f0f0f0',
        marginRight: 10, color: 'black'
    },
    sendButton: {
        backgroundColor: '#59008F', borderRadius: 25,
        paddingHorizontal: 20, justifyContent: 'center', alignItems: 'center',
    },
    sendButtonText: { color: '#fff', fontWeight: 'bold' },
    userInfo: {
        paddingHorizontal: 10, paddingVertical: 12, flexDirection: 'row',
        alignItems: 'center', gap: 10, backgroundColor: '#fff',
        borderBottomWidth: 1, borderBottomColor: '#ddd',
    },
    userName: { width: 210 },
    promptsContainer: {
        position: 'absolute', bottom: 75, left: 10, right: 10,
        flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-around'
    },
    prompt: {
        backgroundColor: '#fff', padding: 8, borderRadius: 20,
        margin: 4, borderWidth: 1, borderColor: 'grey'
    },
